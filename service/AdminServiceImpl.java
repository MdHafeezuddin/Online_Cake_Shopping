...
//	@Override
//    public Cake updateCakes(int cakeId,Cake cake) {
//        Optional<Cake> cakes=cakeRepo.findById(cakeId);
//        if(!cakes.isPresent())throw new  CakeIdNotFoundException("invalid id found");
//        Cake cake1=cakeRepo.getById(cakeId);
//        
//        
//        if(cake.getCakeName()!=null)
//            cake.setCakeName(cake.getCakeName());
//        if(cake.getCakePrice()!=0)
//            cake.setCakePrice(cake.getCakePrice());
//        if(cake.getCakeQuantity()!=0)
//            cake.setCakeQuantity(cake.getCakeQuantity());
//           
//        Cake updatedcake=cakeRepo.save(cake1);
//        
//        
//        
//        return updatedcake;   
