...
public class AdminController {
	...
	public ResponseEntity<Cake> deleteVegById(@PathVariable("cakeId") int cakeId)  throws CakeIdNotFoundException{
	...
	// http://localhost:8091/onlinecakeorder/admin/update/



//	   @PutMapping("/update/{cakeId}")
//	    public ResponseEntity updateCake(@PathVariable("cakeId") Integer cakeId,  @RequestBody Cake cake ) throws CakeIdNotFoundException  {
//	        Cake updatecak = adServe.updateCakes(cakeId,cake);
//
//
//
