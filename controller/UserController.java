...
public class UserController {
	...
	public ResponseEntity deleteById(@PathVariable("cakeId") int cakeId) throws CakeIdNotFoundException
	{
	...
	public ResponseEntity getcakeById(@PathVariable("cakeId") int cakeId) throws CakeIdNotFoundException {
